...
namespace Models
{
	...
	{
		public static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""LeaveApplicationProcessed"",""namespace"":""Models"",""fields"":[{""name"":""EmpEmail"",""type"":""string""},{""name"":""EmpDepartment"",""type"":""string""},{""name"":""LeaveDurationInHours"",""type"":""int""},{""name"":""LeaveStartDateTicks"",""type"":""long""},{""name"":""ProcessedBy"",""type"":""string""},{""name"":""Result"",""type"":""string""}]}");
